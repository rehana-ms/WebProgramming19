...
class SimpleTest(unittest2.TestCase):
    ...
    def test_book1(self):
        book = get_book(self.DB_SESSION , '380795272')
        self.assertEquals(book[0].isbn, '380795272')
    def test_book3(self):
        book = get_book(self.DB_SESSION, '1416949658')
        self.assertEquals(book[0].isbn, '1416949658')
    def test_book4(self):
        book = get_book(self.DB_SESSION, '1857231082')
        self.assertEquals(book[0].isbn, '1857231082')
    def test_book5(self):
        book = get_book(self.DB_SESSION, '553803700')
        self.assertEquals(book[0].isbn, '553803700')
    def test_book6(self):
        book = get_book(self.DB_SESSION, '080213825X')
        self.assertEquals(book[0].isbn, '080213825X')
    def test_book7(self):
        book = get_book(self.DB_SESSION, '0802138')
        if(len(book) == 0):
            book = None
